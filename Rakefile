...
desc "Build the development version"
task :work => %w[css_work work/index.html work/javascripts/jquery.min.js work/javascripts/my_zwave.js]

desc "Build the production version"
task :dist => %w[fingerprinted_js dist/index.html]
...
task :fingerprinted_js => %w[fingerprinted_myzwave_js]
